...
# 2. Load Pre-trained Machine Learning Models (Pipelines)
@st.cache_resource
def load_all_assets():
...
# Pipelines automatically process features internally and output accurate numbers
...
# Chained Physics Multipliers Evaluation Constants (Row 0 Ground Truths)
...
with st.expander("See Systems Scaling Logic"):
    ...
    with col_b:
        st.markdown(f"**Stage 2: Thermal Envelope Multiplier:** `{mult_total:.2f}x scaling effect`")